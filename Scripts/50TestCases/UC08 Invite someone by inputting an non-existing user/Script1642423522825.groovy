...
WebUI.setText(findTestObject('Object Repository/Page_Element  MQK space/input_share this space_focus-visible'), 'asfas@masvf')

WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/div_Invite'))

WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/button_OK'))
