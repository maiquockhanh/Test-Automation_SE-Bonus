...
WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/h3_Invite people'))

WebUI.setText(findTestObject('Object Repository/Page_Element  MQK space/input_share this space_focus-visible'), '@asvasv')
