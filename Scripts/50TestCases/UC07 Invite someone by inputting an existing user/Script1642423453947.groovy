...
WebUI.click(findTestObject('Object Repository/Page_Element  General/div_General_mx_RoomHeader_chevron'))

WebUI.click(findTestObject('Object Repository/Page_Element  General/span_Invite'))

WebUI.setText(findTestObject('Object Repository/Page_Element  General/input_share this room_focus-visible'), '@quangvust201:matrix.org')

WebUI.sendKeys(findTestObject('Object Repository/Page_Element  General/input_share this room_focus-visible'), Keys.chord(
        Keys.ENTER))
