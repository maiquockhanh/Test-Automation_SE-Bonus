...
WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/div_Invite'))

WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/div_Invite peopleInvite with email or username'))

WebUI.setText(findTestObject('Object Repository/Page_Element  MQK space/input_share this space_focus-visible'), 'quangvust201@gmail.com')

WebUI.sendKeys(findTestObject('Object Repository/Page_Element  MQK space/input_share this space_focus-visible'), Keys.chord(
        Keys.ENTER))
