...
WebUI.setText(findTestObject('Object Repository/Page_Element  MQK space/input_share this space_focus-visible'), '@quangvust201')

WebUI.click(findTestObject('Object Repository/Page_Element  MQK space/div_Qquangvust201quangvust201matrix.org'))
