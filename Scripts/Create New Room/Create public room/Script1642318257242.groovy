...
CustomKeywords.'khanh.wait.DelayTime'(10)
...
WebUI.click(findTestObject('Object Repository/Page_Element/div_Private room (invite only)'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Public room'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input_Create a public room_mx_Field_5'), 'Room test1')

WebUI.click(findTestObject('Object Repository/Page_Element/button_Create Room'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input__mx_Field_7'), 'room-test-01')
