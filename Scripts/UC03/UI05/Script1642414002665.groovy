...
WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Verify_mx_SpaceButton_icon'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/h3_Public'))

WebUI.setText(findTestObject('Object Repository/Page_Element 1/input_Upload_spaceName'), 'ddgyjj')

WebUI.click(findTestObject('Object Repository/Page_Element 1/input__mx_Field_6'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Addressmatrix.org'))

WebUI.setText(findTestObject('Object Repository/Page_Element 1/input__mx_Field_6'), '')

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Create'))
