...
WebUI.click(findTestObject('Object Repository/Page_Element 1/h3_Private'))

WebUI.setText(findTestObject('Object Repository/Page_Element 1/input_Upload_spaceName'), 'fsfsfsfsfs')

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Create'))

WebUI.click(findTestObject('Object Repository/Page_Element/h3_Just me'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Skip for now'))
