...
WebUI.click(findTestObject('Object Repository/Page_Element 4/div_Preview'))

CustomKeywords.'khanh.wait.DelayTime'(10000)

WebUI.click(findTestObject('Object Repository/Page_Element/div_Join the discussion'))
