...
WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Rooms_mx_AccessibleButton mx_RoomSublis_27fc2e'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/span_Explore public rooms'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_Matrix rooms (matrix.org)'))

WebUI.click(findTestObject('Object Repository/Page_Element 1/div_OFTC'))
