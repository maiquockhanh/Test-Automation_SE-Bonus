...
WebUI.setText(findTestObject('Object Repository/Page_Element/input_Create a private room_mx_Field_5'), 'Room test7')
...
WebUI.setText(findTestObject('Object Repository/Page_Element/input__mx_Field_7'), 'room-test-07')
