...
WebUI.click(findTestObject('Object Repository/Page_Element/input_Create a private room_mx_Field_4'))

WebUI.click(findTestObject('Object Repository/Page_Element/span_Private room (invite only)_mx_Dropdown_arrow'))

WebUI.click(findTestObject('Object Repository/Page_Element/div_Public room'))

WebUI.setText(findTestObject('Object Repository/Page_Element/input__mx_Field_6'), 'room-test-09')
