...
WebUI.click(findTestObject('Object Repository/Page_Element 5/div_Verify other device_mx_AccessibleButton_7edffc'))

WebUI.click(findTestObject('Object Repository/Page_Element 5/div_Room test1'))

WebUI.click(findTestObject('Object Repository/Page_Element 5  Room test1/div_expand'))

WebUI.click(findTestObject('Object Repository/Page_Element 5  Room test1/div_Invite to this room'))

WebUI.click(findTestObject('Object Repository/Page_Element 5  Room test1/div_Aaragilar_oftc_aragilarmatrix.org'))

WebUI.click(findTestObject('Object Repository/Page_Element 5  Room test1/div_Invite'))
